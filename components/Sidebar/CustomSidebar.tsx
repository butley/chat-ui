...
export const CustomSidebar: FC<Props> = ({
  loading,
  conversations,
  lightMode,
  ...
  return (
    <aside
      className={`top-0 bottom-0 z-50 flex h-full w-[260px] flex-none flex-col space-y-2 bg-[#202123] p-2 transition-all sm:relative`}
    >
